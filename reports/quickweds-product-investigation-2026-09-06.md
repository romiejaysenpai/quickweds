...
| Guest | No-account public interactions and emailed guest passes are good foundations; identity and context fragment across RSVP, seat finder and photos. | One recognizable link, one clear action at each stage, Assessment | What would earn trueditable responses, directions and a reliable fallback. |
