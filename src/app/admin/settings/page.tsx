...
import { Settings, ShieldCheck, Power, Lock, Zap, Save, CheckCheck } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-background px-4 py-8">
            <div className="mx-auto max-w-4xl rounded-3xl border border-border bg-white p-5 shadow-xl sm:p-8">
                <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between border-b border-border pb-6">
                    <div>
