...
function AccountTypeOnboardingContent() {
    ...
    const handleFinishAndEnterDashboard = () => {
        ...
        router.replace(userRole === 'Wedding planner / coordinator' ? '/coordinator' : '/dashboard');
    };
                    ...
                    {step === 'ready' && (
                        ...
                        >
                            ...
                            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
                                ...
                                >
                                    {userRole === 'Wedding planner / coordinator' ? 'Open Coordinator Workspace' : 'Enter My Dashboard'} <ArrowRight className="w-5 h-5" />
                                </button>
                                <Link
                                    href="/builder"
