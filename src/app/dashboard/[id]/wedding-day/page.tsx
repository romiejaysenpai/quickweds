            ...
            <div className="mx-auto max-w-5xl">
                ...
                <section className="rounded-3xl border border-primary/15 bg-white p-5 shadow-xl shadow-primary/10 sm:p-8">
                    ...
                    <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
                        ...
                        <Metric label="Checked In" value={`${counters.checkedInGuests}/${counters.totalRsvps}`} />
                        <Metric label="Check-In" value={`${checkInPercent}%`} />
                        <Metric label="Photos" value={counters.photoUploadCount} />
                    </div>
                </section>

                <section className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
                    <ActionCard href={`/dashboard/${weddingId}/check-in`} icon={ClipboardCheck} label="Check-In" description="Search guests and mark arrivals." />
                    ...
                    <ActionCard href={`/dashboard/${weddingId}/photo-uploads`} icon={Camera} label="Photo Uploads" description="Review guest photo submissions." />
                    <ActionCard href={`/dashboard/${weddingId}/planner?tab=seating`} icon={Users} label="Seating" description="Open tables and assignments." />
                    <ActionCard href={`/dashboard/${weddingId}/wedding-day/coordinator-report`} icon={FileText} label="Handoff Report" description="Export or print the complete report." />
                </section>

                <form onSubmit={handleSubmit} className="mt-6 grid gap-5 lg:grid-cols-[minmax(0,1fr),minmax(0,1fr)]">
