                        ...
                        <div className="p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-3xl bg-primary text-white shadow-xl shadow-primary/20">
                            ...
                            <div className="grid grid-cols-3 gap-2 sm:gap-3">
                                <CopyButton 
                                    text={url}
                                    label="Copy"
                                    className="flex flex-col items-center gap-1 p-2 sm:p-3 rounded-lg sm:rounded-xl bg-white/10 hover:bg-white/20 transition-colors min-h-[44px] border-0 text-white"
                                />
