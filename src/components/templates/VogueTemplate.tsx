        ...
        <div className="bg-white text-black font-sans selection:bg-black selection:text-white pb-24">
            <section className="min-h-screen grid grid-cols-1 md:grid-cols-2">
                <div className="relative h-[60vh] md:h-full order-2 md:order-1">
                    <SafeWeddingImage src={wedding.hero_image || wedding.couple_photo} alt={`${wedding.bride_name} and ${wedding.groom_name}`} fallbackText={wedding.logo_initials} className="absolute inset-0 w-full h-full object-cover grayscale contrast-125" />
            ...
            <section className="py-16 sm:py-24 md:py-32 lg:py-32 px-4 sm:px-6">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8 sm:gap-12 md:gap-16 lg:gap-24 items-center">
                    ...
                    <div className="w-full md:w-1/3 aspect-[3/4] relative">
                        ...
                        <SafeWeddingImage src={wedding.couple_photo} alt={`${wedding.bride_name} and ${wedding.groom_name}`} fallbackText={wedding.logo_initials} className="w-full h-full object-cover relative z-10 grayscale hover:grayscale-0 transition-all duration-700" />
                    </div>
                </div>
            </section>
            ...
            <GallerySection id="gallery" gallery={gallery} masonry template={wedding.template} motifColor={wedding.motif_color} />
