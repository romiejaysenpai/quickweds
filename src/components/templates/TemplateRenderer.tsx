...
export const TEMPLATE_COMPONENTS = {
    ...
    palefloral: PremiumTemplate,
    classyphoto: PremiumTemplate,
    mellowwave: PremiumTemplate,
    mizuhiki: PremiumTemplate,
    neumorphism: PremiumTemplate,
    aromabotanical: PremiumTemplate,
    magazinecover: PremiumTemplate,
    lunette: PremiumTemplate,
    museum: PremiumTemplate,
    frostedglass: PremiumTemplate,
    astronomy: PremiumTemplate,
    streamline: PremiumTemplate,
    marble: PremiumTemplate,
    luxeheart: PremiumTemplate,
    flowerflow: PremiumTemplate,
    faintblur: PremiumTemplate,
    splash: PremiumTemplate,
    polaroid: PremiumTemplate,
    kimono: PremiumTemplate,
    duotone: PremiumTemplate,
    seigaiha: PremiumTemplate,
    asanoha: PremiumTemplate,
    holynight: PremiumTemplate,
    snowwhite: PremiumTemplate,
    teaceremony: PremiumTemplate,
    anemone: PremiumTemplate,
    camellia: PremiumTemplate,
    hydrangea: PremiumTemplate,
    notepaper: PremiumTemplate,
    petlove: PremiumTemplate,
    weddingtimes: PremiumTemplate,
    mimosa: PremiumTemplate,
    oceanblue: PremiumTemplate,
    emerald: PremiumTemplate,
    washipaper: PremiumTemplate,
    mistveil: PremiumTemplate,
    linea: PremiumTemplate,
    planetarium: PremiumTemplate,
    forest: PremiumTemplate,
    jazz: PremiumTemplate,
    heritage: PremiumTemplate,
    sunflower: PremiumTemplate,
    mermaidbeach: PremiumTemplate,
    passport: PremiumTemplate,
    enchanted: PremiumTemplate,
    coralsea: PremiumTemplate,
    oldpaper: PremiumTemplate,
    lapin: PremiumTemplate,
    yellowsummer: PremiumTemplate,
    retroflower: PremiumTemplate,
    daisygarden: PremiumTemplate,
    clearblue: PremiumTemplate,
    musicfest: PremiumTemplate,
    botanicalgreen: PremiumTemplate,
    fluidmodern: PremiumTemplate,
    springrise: PremiumTemplate,
    truelove: PremiumTemplate,
    oceanus: PremiumTemplate,
    airport: PremiumTemplate,
    noweddingnolife: PremiumTemplate,
    arrangeflowers: PremiumTemplate,
    gradientleaf: PremiumTemplate,
    growthtale: PremiumTemplate,
    innocentpetals: PremiumTemplate,
    deeporange: PremiumTemplate,
    hanaume: PremiumTemplate,
    bluebird: PremiumTemplate,
    gardenwedding: PremiumTemplate,
    minimumstyle: PremiumTemplate,
    music: PremiumTemplate,
    royalblue: PremiumTemplate,
    letter: PremiumTemplate,
    naturalcamper: PremiumTemplate,
    modernsquare: PremiumTemplate,
    japan: PremiumTemplate,
    weddingcake: PremiumTemplate,
    akamatsu: PremiumTemplate,
    kasumi: PremiumTemplate,
    konatsu: PremiumTemplate,
    balloonrelease: PremiumTemplate,
