...
import {
    ...
    TemplateVariationV4,
    TemplateVariationV5,
} from './TemplateVariations';

export const ClassicV2 = TemplateVariationV2;
export const ClassicV3 = TemplateVariationV3;
export const ClassicV4 = TemplateVariationV4;
export const ClassicV5 = TemplateVariationV5;
