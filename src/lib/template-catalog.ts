...
const TEMPLATE_FILTERS: Record<Exclude<TemplateFilter, 'all'>, readonly string[]> = {
    ...
    modern: ['minimal', 'timeline', 'rsvpfocus', 'vogue', 'editorial', 'couture-grid'],
    romantic: ['romantic', 'whimsical', 'sakura', 'garden', 'rustic', 'boho', 'paperie', 'verdant-frame'],
    destination: ['elopement', 'tropical', 'cinematic', 'film', 'solstice'],
    bold: ['luxury', 'midnight', 'urban', 'glitch', 'vogue', 'editorial', 'opal-evening', 'couture-grid'],
};
...
export function recommendTemplateIds(input: TemplateRecommendationInput) {
    const signals: Record<string, readonly string[]> = {
        ...
        'mood:soft': ['romantic', 'sakura', 'garden', 'paperie', 'verdant-frame'],
        'mood:clean': ['minimal', 'editorial', 'timeline', 'couture-grid', 'rsvpfocus'],
        'mood:dramatic': ['luxury', 'midnight', 'opal-evening', 'cinematic', 'artdeco'],
        'mood:playful': ['boho', 'tropical', 'whimsical', 'glitch'],
        'venue:ballroom': ['classic', 'luxury', 'royal', 'artdeco'],
        'venue:garden': ['garden', 'verdant-frame', 'romantic', 'sakura', 'boho'],
        'venue:beach': ['tropical', 'solstice', 'elopement', 'boho', 'cinematic'],
        'venue:city': ['urban', 'editorial', 'vogue', 'minimal'],
        'venue:intimate': ['elopement', 'minimal', 'romantic', 'vintage'],
        'priority:photos': ['editorial', 'couture-grid', 'cinematic', 'film', 'vogue'],
...
export const TEMPLATES: TemplateCatalogItem[] = [
    ...
    },
    {
        id: 'solstice',
        name: 'Solstice',
        desc: 'A sun-drenched celebration built around bold color, horizon light, and an open-air welcome.',
        accent: '#D9683D',
        eyebrow: 'Golden Gathering',
        mood: 'Terracotta sun, sea-blue shadow, and a long-table evening',
        tier: 'premium',
        previewGradient: 'linear-gradient(135deg, #fff0d8 0%, #f6bd67 48%, #d9683d 100%)',
    },
    {
        id: 'paperie',
        name: 'Paperie',
        desc: 'A tactile stationery-inspired invitation with layered paper, ribbons, and quiet romance.',
        accent: '#786B9A',
        eyebrow: 'A Keepsake Invitation',
        mood: 'Lilac paper, inked edges, and pressed-flower charm',
        tier: 'premium',
        previewGradient: 'linear-gradient(135deg, #fffdf8 0%, #eee9f5 50%, #b6a9cf 100%)',
    },
    {
        id: 'verdant-frame',
        name: 'Verdant Frame',
        desc: 'A conservatory-style layout with sculptural greenery and a framed portrait moment.',
        accent: '#386B56',
        eyebrow: 'Conservatory Vows',
        mood: 'Deep leaves, pale stone, and a garden portrait',
        tier: 'premium',
        previewGradient: 'linear-gradient(135deg, #f8fbf5 0%, #c8ddc3 50%, #386b56 100%)',
    },
    {
        id: 'opal-evening',
        name: 'Opal Evening',
        desc: 'An iridescent night invitation with a luminous portrait halo and jewel-tone depth.',
        accent: '#B8A6E8',
        eyebrow: 'An Opal Night',
        mood: 'Ink blue, violet light, and a celestial shimmer',
        tier: 'premium',
        previewGradient: 'linear-gradient(135deg, #0a1023 0%, #302b57 50%, #b8a6e8 100%)',
    },
    {
        id: 'couture-grid',
        name: 'Couture Grid',
        desc: 'A high-fashion editorial designed around oversized masthead type and art-directed imagery.',
        accent: '#202020',
        eyebrow: 'The Wedding Issue',
        mood: 'Studio white, ink black, and a fashion-editorial rhythm',
        tier: 'premium',
        previewGradient: 'linear-gradient(135deg, #ffffff 0%, #e5e2dc 50%, #77716a 100%)',
    },
];
