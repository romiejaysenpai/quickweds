# 🎨 Universal Welcome Dashboard Hero UI & System Message Blueprint

A mobile-first Welcome Dashboard Hero component and AI Agent Skill that features the signature **left-side mascot illustration** and **right-side floating system message speech bubble card**.

---

## 🏗️ 2-Column Hero Slice: Mascot (Left) + System Message (Right)
...
## 💻 Standalone Component (`WelcomeDashboardHero.tsx`)
...
export default function WelcomeDashboardHero({
  userName = 'there',
